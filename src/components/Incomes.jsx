...
export const Incomes = () => {
    ...
    const handleDelete = () => {
      ...
      const updatedIncomes = Incomes.filter((income) => income.id !== incomeToDelete.id);
    ...
    const totalAmount = currentMonthIncomes.reduce((acc, income) => acc + Number(income.amount), 0);
